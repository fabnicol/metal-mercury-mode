...
("Predicate decls" "^:-[ \t]*pred[ \t]+\\([a-z]+[a-zA-Z0-9()!:., \t_]*\\)" 1)
("Predicate rules"  "^[ \t]*\\([a-z]+[a-zA-Z0-9()!:., \t_]*\\)[ \t]*\\(:-\\|-->\\)" 1)
("Function decls" "^:-[ \t]*func[ \t]+\\([a-z]+[a-zA-Z0-9()!:., \t_]*\\)" 1)
("Function rules" "^[ \t]*\\([a-z]+[a-zA-Z0-9()!:., \t_]*\\)[ \t]*=[ \t]*\\([A-Z_]+[a-zA-Z0-9_]*\\)[ \t]*\\(:-\\|-->\\)" 1)
